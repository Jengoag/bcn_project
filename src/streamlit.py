...
option=st.sidebar.selectbox('',('Select graph', 'Population by Age','Population by District', 'Rent by Distric', 'Wifi by District', 'Animals by District', 'Areas by District','Parks by District'))
